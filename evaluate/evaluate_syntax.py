...
layers.AttentiveConcatenateLayer=AttentiveConcatenateLayer
layers.OneHotLayer=OneHotLayer
layers.AttentionLayer=AttentionLayer

model=load_model(path) #,custom_objects={'AttentiveConcatenateLayer':AttentiveConcatenateLayer,'AttentionLayer':AttentionLayer,'OneHotLayer':OneHotLayer})
print 'Loaded model'
print 'Results on Validation data'
X=np.load('../train_data_dev_X.npz')['arr_0']
syntax_X=np.load('../cnn_syntax/syntax_X_dev.npz')['arr_0']
y_true=np.load('../train_data_dev_Y.npz')['arr_0']
y_pred=model.predict([X,syntax_X],batch_size=batch_size)
...
syntax_X=np.load('../syntax_X_test.npz')['arr_0']
