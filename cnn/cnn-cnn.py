...
save_filename='models/cnn-cnn_1_transformed_embeddings_regularized'
...
checkpoint=ModelCheckpoint('bestmodels/cnn_cnn_transformed_embeddings',monitor='val_acc',save_best_only=True,mode='max',verbose=1)
